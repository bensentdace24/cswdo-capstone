            ...
            <div class="container-fluid">
                ...
                <div id="printableArea" class="print-wrapper">
                    ...
                    <div class="ar-copy ar-box mb-3">
                        @include('admin.ar.partials.ar_copy', ['record' => $record])
                    </div>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="col-sm-12 no-print mb-4 mt-2">
                <div class="d-flex justify-content-end align-items-center gap-3" style="gap: 12px;">
                    <!-- Back Button with Tooltip -->
                    <a href="{{ url('admin/ar/viewing-list') }}" class="btn btn-outline-secondary" data-toggle="tooltip" title="Go Back" style="font-size: 1.1rem;">
                        <i class="fas fa-arrow-left"></i>
                    </a>

                    <!-- Print Button with Tooltip -->
                    <button onclick="printAR()" class="btn btn-outline-success" data-toggle="tooltip" title="Print Receipt" style="font-size: 1.1rem;">
                        <i class="fas fa-print"></i>
                    </button>
                </div>
            </div>
            ...
            <div id="printableArea" class="print-wrapper">
                ...
                <div id="printableArea" class="card px-5 py-4" style="background-color: #fff; font-family: 'Arial', sans-serif; border: 1px solid #ccc; line-height: 1.8;">
