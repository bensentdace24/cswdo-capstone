...
<div class="content-wrapper">
        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center flex-wrap">
                ...
                <div class="d-flex align-items-center mt-2 mt-md-0">
                    ...
                    <a href="{{ url('admin/ar/add') }}" class="text-primary" data-toggle="tooltip" title="Add Acknowledgement" style="font-size: 1.4rem; margin-right: 16px;">
                        <i class="fas fa-pencil-alt"></i>
                    </a>

                    <!-- View Saved Acknowledgements Icon (Folder Open) -->
                    <a href="{{ url('admin/ar/viewing-list') }}" class="text-secondary" data-toggle="tooltip" title="View Saved Acknowledgements" style="font-size: 1.4rem;">
    ...
    <section class="content">
        <div class="container-fluid">
            @include('_message')
            <div class="card px-5 py-4" style="background-color: #fff; font-family: 'Arial', sans-serif; border: 1px solid #ccc; line-height: 1.8;">
                ...
                <div style="font-size: 16px; text-align: justify;">
                    <p>
                        ...
                        <u><strong>ONE THOUSAND TWO HUNDRED PESOS ONLY</u> (₱ <u>1,200.00</strong></u>) for the Assistance for Individual in Crisis Situation (AICS)
                        <u><strong>MEDICAL / FINANCIAL ASSISTANCE</strong></u>.
                    </p>

                    <p>
                        Received this <u><strong>27TH</strong></u> day of <u><strong>DECEMBER 2024</strong></u> at LGU-Panabo City CSWDO.
                    </p>
                </div>
