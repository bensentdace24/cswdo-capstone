        ...
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-sm-12 d-flex align-items-center">
                    ...
                    <a href="{{ url('/admin/dashboard') }}" style="color: #6c757d; font-size: 1.5rem; margin-right: 15px; text-decoration: none;">
                        <i class="fas fa-chevron-left"></i>
                    </a>
                    <div>
                        <h1 class="text-3xl font-semibold text-gray-800" style="font-size: 2.2rem; font-weight: 700; color: #333; margin: 0;">My Account</h1>
                        <p style="font-size: 1rem; color: #6c757d; margin: 0; padding-top: 2px;">Update your personal profile information.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-8 col-lg-6">
                    ...
                    <div class="card" style="border-radius: 12px; box-shadow: 0 8px 25px rgba(0,0,0,0.08); border: none; overflow: hidden;">
                        ...
                        <div class="card-header" style="background-color: #f7f7f7; padding: 25px 40px; border-bottom: 1px solid #eee;">
                            <h2 style="font-size: 1.5rem; font-weight: 600; color: #333; margin-bottom: 5px;">Profile Details</h2>
                        ...
                        <form method="post" action=""> {{-- Keep action empty as per original code --}}
                            ...
                            <div class="card-body" style="padding: 40px;">
                                <div class="row">
                                    ...
                                    {{-- Email --}}
                                    <div class="form-group col-md-12" style="margin-bottom: 30px;">
                                        <label style="font-weight: 600; color: #555; margin-bottom: 10px; display: block;">Email <span style="color: #dc3545;">*</span></label>
