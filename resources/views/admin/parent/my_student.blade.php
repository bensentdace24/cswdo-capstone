                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {{ optional($student->parent)->name ?? 'N/A' }}
                                            @else
                                            N/A
                                            @endif
                                        </td>
                                        ...
                                        <td style="min-width: 150px;">
                                            <a href="{{ url('admin/parent/assign_student_parent/'.$student->id.'/'.$parent_id) }}" class="btn btn-primary btn-sm">Add Student to Parent</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ date('d-m-Y H:i A', strtotime($student->created_at)) }}</td>
                                        <td style="min-width: 150px;">
                                            <a href="{{ url('admin/parent/assign_student_parent_delete/'.$student->id) }}" class="btn btn-danger btn-sm">Delete</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
