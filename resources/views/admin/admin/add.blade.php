        ...
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-sm-12 d-flex align-items-center">
                    {{-- Back Button --}}
                    <a href="{{ url('admin/admin/list') }}" style="color: #6c757d; font-size: 1.5rem; margin-right: 15px; text-decoration: none;">
                        <i class="fas fa-chevron-left"></i>
                    </a>
                    <div>
                        <h1 style="font-size: 2.2rem; font-weight: 700; color: #333; margin: 0;">Add New Admin</h1>
                        <p style="font-size: 1rem; color: #6c757d; margin: 0; padding-top: 2px;">Create a new user with administrative access.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-8 col-lg-6">
                    ...
                    <div class="card" style="border-radius: 12px; box-shadow: 0 8px 25px rgba(0,0,0,0.08); border: none; overflow: hidden;">
                        ...
                        <div class="card-header" style="background-color: #f7f7f7; padding: 25px 40px; border-bottom: 1px solid #eee;">
                            <h2 style="font-size: 1.5rem; font-weight: 600; color: #333; margin-bottom: 5px;">New Administrator Details</h2>
                            <p style="font-size: 0.95rem; color: #6c757d; margin: 0;">All fields are required for security.</p>
                        </div>
                        ...
                        <form method="post" action="{{ url('admin/admin/add') }}">
                            ...
                            <div class="card-body" style="padding: 40px;">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12" style="margin-bottom: 30px;">
                                        ...
                                        <input type="email" class="form-control" name="email" value="{{ old('email') }}" required placeholder="Enter valid email"
                                            style="border: none; border-bottom: 1px solid #ccc; border-radius: 0; padding: 8px 0; background-color: transparent; box-shadow: none; font-size: 1rem;">
                                    ...
                                    {{-- CRITICAL SECURITY: Password Confirmation --}}
                                    <div class="form-group col-md-6" style="margin-bottom: 30px;">
                                        ...
                                        <input type="password" class="form-control" name="password_confirmation" required placeholder="Re-enter password"
                                            style="border: none; border-bottom: 1px solid #ccc; border-radius: 0; padding: 8px 0; background-color: transparent; box-shadow: none; font-size: 1rem;">
                                        {{-- Laravel will use the error message for 'password' if they don't match --}}
                                    </div>
                            ...
                            <div class="card-footer" style="padding: 25px 40px; background-color: #f7f7f7; border-top: 1px solid #eee; display: flex; justify-content: flex-end;">
                                {{-- Back Button --}}
                                <a href="{{ url('admin/admin/list') }}" class="btn btn-secondary"
