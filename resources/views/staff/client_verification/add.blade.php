...
@section('content')
    <div class="content-wrapper" style="background-color: #e4e4e4; min-height: 100vh;">
        ...
        <section class="content">
            <div class="container-fluid">
                <form method="POST" action="{{ url('staff/client_verification/add/' . $client->id) }}">
                    @csrf
                    <div class="card card-primary" style="background-color: #f7f7f7;">
                        <div class="card-body">
                                ...
                                @foreach ($client_checks as $field => $label)
                                    <div class="form-group col-md-4">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="client_assessment[]"
                                                value="{{ $field }}"
                                                {{ is_array(old('client_assessment')) && in_array($field, old('client_assessment')) ? 'checked' : '' }}>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                @foreach ($communityOptions as $key => $label)
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" name="community_assessment[]"
                                            value="{{ $key }}">
                                        <label class="form-check-label">{{ $label }}</label>
                                    </div>
                                @endforeach
                            ...
                            <div class="form-group row">
                                <div class="col-md-4">
                                    ...
                                    <input type="date" name="disaster_date" class="form-control"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="disaster_type" class="form-control">
                                        ...
                                        <option value="fire" {{ old('disaster_type') == 'fire' ? 'selected' : '' }}>Fire
                                        </option>
                                        <option value="flood" {{ old('disaster_type') == 'flood' ? 'selected' : '' }}>
                                            Flood</option>
                                        <option value="other" {{ old('disaster_type') == 'other' ? 'selected' : '' }}>
                                            Other</option>
                                    </select>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <select name="damage_type" class="form-control">
                                        ...
                                        <option value="partially"
                                            {{ old('damage_type') == 'partially' ? 'selected' : '' }}>Partially</option>
                                        <option value="totally" {{ old('damage_type') == 'totally' ? 'selected' : '' }}>
                                            Totally</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-md-4">
                                    ...
                                    <select name="household_type" class="form-control">
                                        <option value="">Select</option>
                                        <option value="owned" {{ old('household_type') == 'owned' ? 'selected' : '' }}>
                                            Owned</option>
                                        <option value="rented" {{ old('household_type') == 'rented' ? 'selected' : '' }}>
                                            Rented</option>
                                        <option value="living_with"
                                            {{ old('household_type') == 'living_with' ? 'selected' : '' }}>Living with
                                        </option>
                                    </select>
                                </div>
                                <div class="form-group col-md-6">
                                    <label>Living With (Specify)</label>
                                    <input type="text" name="living_with" class="form-control"
                                        placeholder="e.g., Mother and 3 children">
                                </div>
                            </div>
                        ...
                        <div class="card-footer"
                            ...
                            {{-- Cancel Button --}}
                            <a href="{{ url('staff/client_verification/list') }}" class="btn btn-secondary"
