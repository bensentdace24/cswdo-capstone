    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid d-flex justify-content-between align-items-center">
                ...
                <a href="{{ url('staff/client/add') }}" class="btn add-client-button-final shadow-sm" data-toggle="tooltip">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="card search-card">
                    ...
                    <form method="get" action="{{ url('staff/client/list') }}">
                        <div class="card-body p-0">
                            <div class="row filter-row g-2">
                                ...
                                <div class="form-group col-md-1 d-grid">
                                    <a href="{{ url('staff/client/list') }}" class="btn btn-reset">
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item"
                                                        href="{{ url('staff/client/edit/' . $value->id) }}">✏️ Edit</a>
                                                    <a class="dropdown-item" onclick="return confirm('Are you sure?')"
                                                        href="{{ url('staff/client/delete/' . $value->id) }}">🗑️
                                                        Delete</a>

                                                    <a class="dropdown-item"
                                                        href="{{ url('staff/client/show/' . $value->id) }}">👁️ View
                                                        Info's</a>

                                                    <div class="dropdown-divider"></div>

                                                    <a class="dropdown-item"
                                                        href="{{ url('staff/client_dependents/list/' . $value->id) }}">👪
                                                        View Dependent/s</a>
                                                    <a class="dropdown-item"
                                                        href="{{ url('staff/client_assistance_logs/add/' . $value->id) }}">📝
                                                        Log Assistance</a>
                                                    <a class="dropdown-item"
                                                        href="{{ url('staff/client_verification/list/' . $value->id) }}">📋
