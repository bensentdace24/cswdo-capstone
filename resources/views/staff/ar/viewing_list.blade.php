        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="card p-4">
                    ...
                    {{-- ✅ Month Filter --}}
                    <form method="GET" action="{{ url('staff/ar/viewing-list') }}" class="mb-3">
                        <div class="row">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-1">
                                <a href="{{ url('staff/ar/viewing-list') }}" class="btn btn-secondary btn-block">
                        ...
                        <tbody>
                            @foreach ($getRecord as $key => $value)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('staff/ar/view/' . $value->id) }}" class="btn btn-sm btn-success"
                                            data-toggle="tooltip" title="View">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="{{ url('staff/ar/edit/' . $value->id . '?finance_officer_name=' . urlencode(request('finance_officer_name'))) }}"
