        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center flex-wrap">
                ...
                <div class="d-flex align-items-center mt-2 mt-md-0">
                    ...
                    <a href="{{ url('staff/ar/add') }}" class="text-primary" data-toggle="tooltip" title="Add Acknowledgement" style="font-size: 1.4rem; margin-right: 16px;">
                        <i class="fas fa-pencil-alt"></i>
                    </a>

                    <!-- View Saved Acknowledgements Icon (Folder Open) -->
                    <a href="{{ url('staff/ar/viewing-list') }}" class="text-secondary" data-toggle="tooltip" title="View Saved Acknowledgements" style="font-size: 1.4rem;">
