...
class ClientVerificationController extends Controller
{
    public function list($client_id = null)
    {
        ...
        return view('staff.client_verification.list', compact('getRecord', 'header_title', 'client'));
    }
    ...
    public function add($client_id)
    {
        ...
        return view('staff.client_verification.add', compact('client', 'client_checks', 'community_checks'));
    }
    ...
    public function insert(Request $request, $client_id)
    {
        ...
        return redirect('staff/client_verification/list')->with('success', 'Beneficiary added successfully!');
    }
    ...
    public function edit($id)
    {
        ...
        return view('staff.client_verification.edit', compact(
            'record',
            'client_checks',
            'community_checks',
            'disaster_types',
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('staff/client_verification/list')->with('success', 'Beneficiary updated successfully!');
    }
