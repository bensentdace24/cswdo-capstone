...
class ClientDependentController extends Controller
{
    public function list($client_id)
    {
        ...
        return view('staff.client_dependents.list', compact('client', 'dependents', 'header_title'));
    }
    ...
    public function index()
    {
        ...
        return view('staff.client_dependents.list', compact('dependents', 'header_title'));
    }

    public function add($client_id)
    {
        $client = \App\Models\Client::findOrFail($client_id);
        return view('staff.client_dependents.add', compact('client'));
    }
    ...
    public function insert(Request $request, $client_id)
    {
        ...
        return redirect('staff/client_dependents/list/' . $client->id)
    ...
    public function edit($id)
    {
        ...
        return view('staff.client_dependents.edit', compact('getRecord', 'client'));
    }
    ...
    public function update($id, Request $request)
    {
        ...
        return redirect('staff/client_dependents/list/' . $client_id)
