...
class ArController extends Controller
{
    ...
    private function updateAI()
    {
        try {
            ...
            Log::info("AI Manual Update:\nKMeans: $out1\nRF: $out2\nAllBrgy: $out3");

            DB::table('ai_updates')->updateOrInsert(['id' => 1], ['updated_at' => now()]);
        } catch (\Exception $e) {
            Log::error("AI Update Failed: " . $e->getMessage());
        }
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/ar/view/' . $ar->id . '?finance_officer_name=' . urlencode($request->finance_officer_name))
    ...
    public function view($id, Request $request)
    {
        ...
        return view('admin.ar.view', compact('record', 'data', 'finance_officer_name'));
    }
