...
class AttendanceController extends Controller
{
    ...
    public function AttendanceReport(Request $request)
    {
        ...
        $data['getClass'] = ClassModel::getClass();
        $data['getRecord'] = StudentAttendanceModel::getRecord($student_name, $class_id, $attendance_date, $attendance_type);
    ...
    public function AttendanceReportTeacher(Request $request)
    {
        ...
        $data['getRecord'] = StudentAttendanceModel::getRecordTeacher($classarray, $student_name, $class_id, $attendance_date, $attendance_type);
