...
class ExaminationsController extends Controller
{
    public function exam_list(Request $request)
    {
        ...
        $data['getRecord'] = ExamModel::getRecord($name, $date);
    ...
    public function exam_schedule(Request $request)
    {
        ...
        $result = array();
        if (!empty($request->query('exam_id')) && !empty($request->query('class_id'))) {
            $getSubject = ClassSubjectModel::MySubject($request->query('class_id'));
            foreach ($getSubject as $value) {
                ...
                $ExamSchedule = ExamScheduleModel::getRecordSingle($request->query('exam_id'), $request->query('class_id'), $value->subject_id);
    ...
    public function exam_schedule_insert(Request $request)
    {
        ...
        if (!empty($request->schedule)) {
            foreach ($request->schedule as $schedule) {
                ...
                if (
                    !empty($schedule['subject_id']) && !empty($schedule['exam_date']) && !empty($schedule['start_time']) && !empty($schedule['end_time'])
